...
const Jobs = () => {
  ...
  <th className="text-center">Current Positions</th>
...
>
  ...
  {/* TOTAL POSITIONS */}
  <td className="py-3 text-center text-gray-700">{totalPositions}</td>

  {/* CURRENT POSITIONS */}
  <td className="py-3 text-center text-gray-700">{currentPositions}</td>
